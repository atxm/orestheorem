   ...
   \end{align*}
    ...
    \begin{frame}{Applications}
        \begin{align*}
            ...
            &\text{ is congested}\\
            \\ % for this example while in the video, I will explain more in detail. Essentially is the idea of how a certain case, navigation technology re computes and performs a new hamiltonian path that is efficient for the driver/traveler to avoid traffic and travel time
            &\\
        \end{align*}
    \end{frame}
